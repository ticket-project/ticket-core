 ...
 *
 * <p>기존 {@code com.ticket.seed.SeedDataLoader}(애플리케이션 기동 시 실행되던 {@code ApplicationRunner})의 적재 책임을
...
final class CuratedSeedLoader implements SeedTask {
    ...
    public Outcome run() {
        ...
        final CuratedSeedInventory inventory =
                CuratedSeedInventory.inspect(jdbcTemplate, statements);
