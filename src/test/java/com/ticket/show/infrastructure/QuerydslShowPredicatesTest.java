...
class QuerydslShowPredicatesTest {
    ...
    void 날짜_필터는_null이면_null을_반환하고_값이_있으면_조건을_반환한다() {
        ...
        assertThat(showQueryHelper.displaySaleStartsAtGoe(LocalDateTime.of(2026, 3, 1, 0, 0)))
                .isNotNull();
        assertThat(showQueryHelper.displaySaleStartsAtLoe(LocalDateTime.of(2026, 3, 31, 23, 59)))
                .isNotNull();
        assertThat(showQueryHelper.displaySaleEndsAtGoe(LocalDateTime.of(2026, 4, 1, 0, 0)))
                .isNotNull();
        assertThat(showQueryHelper.displaySaleEndsAtLoe(LocalDateTime.of(2026, 4, 30, 23, 59)))
                .isNotNull();
