 ...
 * 않으므로(전역 기술 설정은 {@code com.ticket.shared.infrastructure}가 소유한다), 스캔 범위 밖에서 오는 {@code
 * JPAQueryFactory}와 {@code Clock}은 {@code @MockitoBean}으로 대체한다 — 이 테스트는 show bean들이 module 경계 안에서
