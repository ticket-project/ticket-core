...
class ExpirePendingOrdersUseCaseTest {
    ...
    void no_expired_orders_returns_immediately() {
        ExpirePendingOrdersUseCase useCase =
                new ExpirePendingOrdersUseCase(orderRepository, expireOrderUseCase, fixedClock);
    ...
    void due_orders_are_expired_with_clock_now() {
        ...
        verify(orderRepository, times(1))
                .findExpirable(eq(OrderState.PENDING), eq(expectedNow), anyInt());
    }
    ...
    void batch_stops_when_all_expirations_fail() {
        ...
        doThrow(new RuntimeException("boom"))
                ...
                .expireByOrderId(1L, expectedNow);
