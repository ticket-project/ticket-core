...
import com.ticket.booking.internal.application.performanceseat.query.PerformanceSeatMapReadRepository.PerformanceSeatMapRow;
...
class GetPerformanceSeatMapUseCaseTest {
    ...
    @Mock
    private PerformanceSeatMapReadRepository performanceSeatMapReadRepository;
    ...
    void 편성된_좌석만_venue_배치와_등급을_조합해_반환한다() {
        ...
        when(performanceSeatMapReadRepository.findAllByPerformanceId(10L)).thenReturn(rows);
    ...
    void 같은_venue라도_회차마다_다른_좌석과_가격을_반환한다() {
        ...
        when(performanceSeatMapReadRepository.findAllByPerformanceId(10L))
                .thenReturn(List.of(new PerformanceSeatMapRow(501L, 101L, 31L, BigDecimal.valueOf(170000))));
        when(performanceSeatMapReadRepository.findAllByPerformanceId(20L))
    ...
    void 좌석_수와_무관하게_catalog와_booking_조회는_각각_한_번씩만_한다() {
        ...
        verify(performanceSeatMapReadRepository, times(1)).findAllByPerformanceId(10L);
    }
}
