...
/**
 * 조회 결과로 {@link PerformanceSeat} 엔티티를 받는 use case 단위 테스트가 쓰는 fixture다. id는 JPA가 채우는 필드라 생성자 대신
 * reflection으로 심는다.
 */
final class PerformanceSeatFixture {
    ...
    static PerformanceSeat seat(
        ...
        final PerformanceSeat performanceSeat =
                new PerformanceSeat(10L, seatId, performanceGradeId, state, unitPrice);
