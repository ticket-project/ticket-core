...
class BookingEntryPolicyTest {
    ...
    void queue_mode가_없으면_대기열을_요구하지_않는다() {
        BookingEntryPolicy policy =
                new BookingEntryPolicy(null, null, NOW.minusMinutes(5), null, null);
    ...
    void force_off면_대기열을_요구하지_않는다() {
        BookingEntryPolicy policy =
                new BookingEntryPolicy(QueueMode.FORCE_OFF, null, NOW.minusMinutes(5), null, null);
    ...
    void force_on이면_시각과_무관하게_대기열을_요구한다() {
        assertThat(
                        new BookingEntryPolicy(QueueMode.FORCE_ON, null, null, null, null)
                                .isRequiredAt(NOW, null))
                .isTrue();
        assertThat(
                        new BookingEntryPolicy(QueueMode.FORCE_ON, null, null, null, null)
                                .isRequiredAt(NOW, NOW.minusHours(1)))
                .isTrue();
    }
    ...
    void auto는_preopen_시각_이후부터_대기열을_요구한다() {
        ...
        BookingEntryPolicy policy =
                new BookingEntryPolicy(QueueMode.AUTO, null, preopen, null, null);
    ...
    void auto는_now가_없으면_대기열을_요구하지_않는다() {
        BookingEntryPolicy policy =
                new BookingEntryPolicy(QueueMode.AUTO, null, NOW.minusMinutes(5), null, null);
    ...
    void auto는_마감_이후에는_대기열을_요구하지_않는다() {
        BookingEntryPolicy policy =
                new BookingEntryPolicy(QueueMode.AUTO, null, NOW.minusHours(3), null, null);
    ...
    void auto는_마감_시각과_같으면_아직_대기열을_요구한다() {
        BookingEntryPolicy policy =
                new BookingEntryPolicy(QueueMode.AUTO, null, NOW.minusHours(1), null, null);
