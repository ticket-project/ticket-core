...
class BookingEntryPolicyTest {
    ...
    void force_on이면_시각과_무관하게_대기열을_요구한다() {
        assertThat(new BookingEntryPolicy(QueueMode.FORCE_ON, null, null, null, null).isRequiredAt(NOW, null))
                .isTrue();
        assertThat(new BookingEntryPolicy(QueueMode.FORCE_ON, null, null, null, null)
