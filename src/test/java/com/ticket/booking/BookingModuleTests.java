 ...
 * {@code SystemClockConfig}는 {@code com.ticket.shared.infrastructure}가 소유해 STANDALONE 스캔 범위 밖이다.
 * {@code SimpMessagingTemplate}은 {@code WebSocketSeatStatusEventPublisher}(좌석 상태 WebSocket 발행)가 필요로 한다. 이 bean을 만드는
