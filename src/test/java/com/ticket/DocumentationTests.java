...
class DocumentationTests {
    ...
    void 전체_dependency_diagram과_module_canvas_exposed_beans_events를_생성한다() throws java.io.IOException {
        ...
        // (showlike는 catalog로, ticketing은 booking으로 흡수돼 더 이상 없다. payment는
        // ticket-domain-module-redesign Phase 5에서 신설된 entity-only module이다).
        for (final String moduleName : new String[] {
                "booking", "catalog", "member", "payment"
        }) {
        ...
        // booking은 catalog/member의 공개 bean을 참조하고 자기 이벤트를 듣는다.
