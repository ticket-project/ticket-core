...
class BookingModuleSlicingSchemaTest {
    ...
    /**
     * PERFORMANCE_SEATS/PERFORMANCES/SEATS/ORDER_SEATS는 어떤 Flyway migration도 만들지 않는 pre-Flyway baseline(V1 없음,
     * docs/operations.md 참고)이다. booking의 FK 제거 migration이 정상 동작을 검증할 수 있도록, Task 7 이전에 존재했을 법한 cross-module FK까지 재현한다.
     */
