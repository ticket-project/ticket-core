...
/**
 * shared의 공개 계약에는 bean을 등록하지 않고, 공통 실행 코드는 {@code shared.config}와 {@code shared.exception.handler}에만 둔다.
 *
...
class SharedModulePurityTest {
    ...
    static final ArchRule shared의_공개_계약에는_bean을_등록하지_않는다 = noClasses()
            .that()
            .resideOutsideOfPackages("com.ticket.shared.config..", "com.ticket.shared.exception.handler..")
            .should()
