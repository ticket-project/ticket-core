...
class MemberWithdrawalTransactionServiceTest {
    ...
    void withdraw_marks_member_and_social_accounts_with_same_clock_time() {
        MemberWithdrawalTransactionService memberWithdrawalTransactionService =
                new MemberWithdrawalTransactionService(memberRepository, fixedClock);
    ...
    void 이미_탈퇴한_소셜계정은_다시_탈퇴_처리하지_않는다() {
        ...
        Member member =
                new Member(
                        ...
                        Role.MEMBER);
        ReflectionTestUtils.setField(member, "id", 3L);
        MemberSocialAccount alreadyWithdrawn =
                member.addSocialAccount(SocialProvider.KAKAO, "kakao-old");
        ...
        assertThat(connections)
                .containsExactly(new SocialAccountConnection(SocialProvider.GOOGLE, "google-123"));
