...
class LoadTestFixtureSeederTest {
    ...
    void setUp() {
        ...
        jdbcTemplate.execute("""
                CREATE TABLE grades (
                  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, code VARCHAR(50) NOT NULL,
        ...
        jdbcTemplate.execute("""
                CREATE TABLE performance_grades (
                  ...
                  grade_id BIGINT NOT NULL, price NUMERIC(19,2) NOT NULL, sort_order INT NOT NULL,
                  created_at TIMESTAMP NOT NULL, created_by VARCHAR(255) NOT NULL)
                """);
        jdbcTemplate.execute("""
                CREATE TABLE performance_seats (
                  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, performance_id BIGINT NOT NULL,
                  seat_id BIGINT NOT NULL, state VARCHAR(50),
                  performance_grade_id BIGINT NOT NULL, unit_price NUMERIC(19,2) NOT NULL,
    ...
    void appliesGradePricesToPerformanceSeats() {
        ...
        assertEquals(400, count(
                "SELECT COUNT(*) FROM performance_seats WHERE unit_price = 150000"));
        assertEquals(600, count(
                "SELECT COUNT(*) FROM performance_seats WHERE unit_price = 60000"));
    }
