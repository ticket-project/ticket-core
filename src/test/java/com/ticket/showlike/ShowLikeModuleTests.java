 ...
 * com.ticket.core.support.exception}·{@code com.ticket.core.app.support.validation}이 legacy {@code
 * com.ticket.core} 아래에 있고, {@code ShowLike} entity·{@code GetMyShowLikesUseCase} 등 이번 Task
 * 9에서 옮기지 못한 legacy showlike 코드(package-info 참고)가 이 module과 얽혀 "showlike → core"·
 * "core → showlike" 순환으로 오탐된다. {@code spring.modulith.detection-strategy}를 전역으로 바꾸는
