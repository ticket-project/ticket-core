 ...
 *
 * <p>E7xxx 대역은 "공연"으로 묶여 있다. 코드 값이 외부 계약이라 module 경계에 맞춰 재번호하지 않는다. E7001(이미 찜한 대상)은 찜 업무가 like
 * module(옛 favorite)로 분리되며 {@code com.ticket.like.exception.LikeErrorCode}로 옮겨갔다.
 */
