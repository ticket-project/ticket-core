...
import com.ticket.show.PerformanceSummary;
import com.ticket.show.ShowLookup;
import com.ticket.show.ShowSummary;
import com.ticket.show.VenueLayout;
import com.ticket.show.application.performance.query.PerformanceSummaryBatchReadRepository;
...
/**
 * {@link ShowLookup}의 show 소유 구현이다.
 */
@Service
