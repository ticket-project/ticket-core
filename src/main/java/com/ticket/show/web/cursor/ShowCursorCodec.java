package com.ticket.show.web.cursor;
 ...
 *
 * <p>커서 문자열은 HTTP 계약이므로 이 클래스(web 계층)가 소유한다. application과 infrastructure는 타입 값인 {@link ShowCursor}만
 * 주고받는다. 인코딩 형식은 기존과 같은 URL-safe Base64(JSON)이다.
 */
@Component
