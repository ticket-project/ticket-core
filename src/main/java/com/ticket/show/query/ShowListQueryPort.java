 ...
 *
 * <p>지역 조건은 {@code venueIds}로 이미 해석돼 들어온다({@link com.ticket.show.query.RegionVenueIds}). {@code
 * null}은 지역 조건 없음이고, <b>빈 집합은 조건은 있으나 해당 공연장이 없다는 뜻이라 결과가 0건</b>이다 — 둘을 같게 다루면 안 된다.
 */
