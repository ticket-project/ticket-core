...
public class ShowSearchRequest {
    ...
    public ShowSearchCriteria toCountCriteria() {
        return ShowSearchCriteria.of(keyword, category, bookingStatus, startDateFrom, startDateTo, region, null);
    }

    public ShowSearchCriteria toCriteria(final ShowCursorCodec cursorCodec) {
        return ShowSearchCriteria.of(
                keyword, category, bookingStatus, startDateFrom, startDateTo, region, cursorCodec.decode(cursor));
    }
}
