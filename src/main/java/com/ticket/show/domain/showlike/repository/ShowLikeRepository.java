package com.ticket.show.domain.showlike.repository;
 ...
 *
 * <p>{@link #like(Long, Long)}은 scalar id만 받는다 — 호출자(show의 use case)가
 * member 내부 entity(Member)를 참조하지 않고 memberId/showId만 넘길 수 있도록,
