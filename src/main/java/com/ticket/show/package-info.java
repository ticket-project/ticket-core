 ...
 * 공연·회차 조회를 소유한다. 찜(공연 찜)의 HTTP endpoint·use case도 여기 있지만, 찜의 데이터·
 * 불변식은 like module(옛 favorite)이 소유한다(ADR 0008). 물리 공연장(Venue)·물리 좌석(Seat)은
 * venue module이 소유하고, Show는 venueId scalar column만 갖는다.
 *
 * 공개 계약:
