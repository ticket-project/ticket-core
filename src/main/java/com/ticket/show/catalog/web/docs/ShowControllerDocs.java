package com.ticket.show.catalog.web.docs;
...
import com.ticket.show.catalog.application.usecase.GetSaleOpeningSoonShowsUseCase;
import com.ticket.show.catalog.application.usecase.GetShowDetailUseCase;
import com.ticket.show.catalog.web.request.SaleOpeningSoonRequest;
import com.ticket.show.catalog.web.request.ShowListRequest;
import com.ticket.show.catalog.web.request.ShowSearchRequest;
...
/** ShowController Swagger 문서 인터페이스 - Swagger 어노테이션을 Controller에서 분리하여 가독성 향상 */
/**
...
public interface ShowControllerDocs {
    ...
    ApiResponse<GetSaleOpeningSoonShowsUseCase.Output> getShowsSaleOpeningSoon(
            @Parameter(description = "카테고리", example = "CONCERT", required = true) String category,
