 ...
 * com.ticket.show.catalog.web.request.SaleOpeningSoonRequest}의 {@code saleStartDateFrom} 등 query
 * param 이름은 HTTP 계약이라 바꾸지 않았고, {@code toParam()}이 위치 인자로 이 타입에 넘기므로 필드 이름이 달라도 무관하다.
 */
@Getter
