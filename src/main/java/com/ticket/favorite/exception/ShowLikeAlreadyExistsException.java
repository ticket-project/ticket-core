...
/**
 * 이미 찜한 공연을 다시 찜하려 했다(동시 요청 race).
 *
 ...
 * 막혔는지를 좁히는 값이다.
 */
public class ShowLikeAlreadyExistsException extends FavoriteException {
    ...
    public ShowLikeAlreadyExistsException(final long memberId, final long showId) {
        super(HttpStatus.CONFLICT, FavoriteErrorCode.E7001, MESSAGE,
