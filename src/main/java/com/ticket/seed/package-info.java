 ...
 * {@link com.ticket.member.account.application.usecase.SeedLoadTestMembersUseCase}에 붙은 type-level
 * {@code @NamedInterface("seed")}를 통해 {@link com.ticket.member.account.application.usecase.SeedLoadTestMembersUseCase}
...
import com.ticket.member.account.application.usecase.SeedLoadTestMembersUseCase;
