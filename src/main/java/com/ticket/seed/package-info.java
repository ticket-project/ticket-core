 ...
 * {@code member.internal.application.member.command} package가 연 {@code @NamedInterface("seed")}
 * 를 통해 {@link com.ticket.member.internal.application.member.command.SeedLoadTestMembersUseCase}
