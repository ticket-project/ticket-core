 ...
 *
 * <p>{@link AuthenticatedMemberArgumentResolver}는 다른 module의 controller가 {@code
 * com.ticket.member.api.AuthenticatedMember} 파라미터를 받게 해 준다. member는 이 MVC 배선을 모르고 인증 주체 값 계약만 제공한다.
 */
@Configuration
