...
public interface AuthControllerDocs {
    ...
    ApiResponse<RefreshAuthTokenUseCase.Output> refresh(
            @Parameter(hidden = true) String refreshToken, @Parameter(hidden = true) HttpServletResponse response);
    ...
    ApiResponse<ExchangeOAuth2TokenUseCase.Output> exchangeOAuth2Token(
            @Valid ExchangeOAuth2TokenRequest request, @Parameter(hidden = true) HttpServletResponse response);
