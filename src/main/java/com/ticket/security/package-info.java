 ...
 *
 * <p><b>이 module만 계층 대신 기능으로 나눈다.</b> 업무 모듈은 endpoint/application/domain/infrastructure로 읽히지만, 여기
 * 있는 것은 업무가 아니라 인증 기술이라 "무엇에 관한 코드인가"가 더 나은 탐색 단위다. 각 폴더 안에는 계층 폴더를 다시 만들지 않는다.
 *
 * <ul>
