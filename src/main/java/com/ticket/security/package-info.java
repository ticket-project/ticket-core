/**
 * 인증·인가와 그 조립을 소유하는 기술 모듈이다. 회원 데이터는 갖지 않는다 — 계정은 member의 {@code MemberAccountOperations} 공개 계약으로만
 * 만진다.
 *
 ...
 * </ul>
 *
 * <p>공개 계약: {@link com.ticket.security.AccessTokenAuthenticator} — HTTP filter chain을 타지 않는 경로
