 ...
 * {@code performanceId}는 show가 소유한 {@code Performance}에 대한 scalar 식별자일 뿐 cross-module JPA 연관관계나 DB FK가 아니다.
 *
...
public class PerformanceSalesPolicy extends AuditedEntity {
    ...
    /** 예매 접수 기간 안인지 확인한다. 옛 {@code BookingPolicyGuard.ensureBookingOpen}과 같은 오류(E3002/E3001)를 그대로 던진다. */
