...
public class SelectSeatUseCase {
     ...
     *
     * <p><b>여기서 보는 hold 여부는 coordinator가 좌석 락 안에서 다시 보는 것과 같은 검증이 아니다.</b> 이것은 락을 잡기 전의 사전 확인이라, 확인과 선택 사이에 다른 요청이 같은
     * 좌석을 선점할 수 있다. 경쟁 조건의 답은 락 안의 재확인이고 이쪽은 빠른 실패용이다 — 중복처럼 보인다고 한쪽을 지우면 안 된다.
     *
