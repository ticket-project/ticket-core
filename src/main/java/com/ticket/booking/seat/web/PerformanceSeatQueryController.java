 ...
 * 데이터만 다루는 {@code com.ticket.show.performance.web.PerformanceController}가 아니라 booking 소유인 이 {@code
 * booking.seat.web.PerformanceSeatQueryController}에 둔다. URL·JSON 계약은 기존과 동일하다.
 */
@RestController
