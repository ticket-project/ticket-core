 ...
 *
 * <p>{@code performanceGradeId}는 요청이 배정한 값이라 null일 수 있다. 그래서 {@code Long}으로 그대로 받는다 — 진단 값을 unboxing하다가 이 업무 예외가 NPE로
 * 바뀌면 안 된다. 두 값 모두 진단 정보이고 공개 {@code error.data}에는 싣지 않는다.
 */
@Getter
