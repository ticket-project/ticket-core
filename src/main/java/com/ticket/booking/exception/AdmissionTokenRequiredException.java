 ...
 *
 * <p>토큰이 잘못된 것과 없는 것을 구분하는 이유는 클라이언트의 다음 행동이 다르기 때문이다 — 없으면 대기열에 진입해야 하고, 잘못됐으면 다시 발급받아야 한다.
 */
public final class AdmissionTokenRequiredException extends AdmissionTokenException {
