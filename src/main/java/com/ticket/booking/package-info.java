 ...
 * Ticket(entity-only, 원래 별도 ticketing module이었다)을 소유한다.
 *
 ...
 */
@org.springframework.modulith.ApplicationModule(displayName = "Booking", allowedDependencies = {"catalog", "member", "admission"})
