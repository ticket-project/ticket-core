...
import com.ticket.booking.endpoint.docs.HoldControllerDocs;
 ...
 * {@link StartBookingUseCase}에 넘긴다 — 별도의 hold 생성 유스케이스는 없고, 만들지도 않는다. "hold"라는 URL은 선점과 주문 생성을 같은
 * 것으로 보던 시절의 이름이며, 지금 이 endpoint가 만드는 것은 PENDING 주문이다.
 *
 * <p>URL·요청 본문·응답(201, {@code Location}, {@code X-Order-Key}, {@code StartBookingUseCase.Output})은
