 ...
 *
 * <p>이 상수는 admission 검증 구현 내부 전용이다. booking의 HTTP adapter는 이 class를 import하지
 * 않고 헤더 이름 문자열을 직접 다룬 뒤 그 값을 {@link com.ticket.booking.internal.application.admission.AdmissionVerifier}에
