...
public class RedisExpirationListenerConfig {
    ...
    public static final String REDIS_EXPIRATION_SUBSCRIPTION_EXECUTOR =
            "redisExpirationSubscriptionExecutor";
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
            ...
            @Qualifier(REDIS_EXPIRATION_SUBSCRIPTION_EXECUTOR)
                    final Executor redisExpirationSubscriptionExecutor) {
        ...
        container.addMessageListener(
                redisKeyExpirationListener, new PatternTopic(EXPIRED_EVENT_PATTERN));
        return container;
    }

    @Bean
    public ApplicationRunner enableRedisKeyspaceNotifications(
            final RedisConnectionFactory redisConnectionFactory) {
        return args -> {
            ...
            try {
                ...
                connection
                        .serverCommands()
                        .setConfig(NOTIFY_KEYSPACE_EVENTS, REQUIRED_NOTIFY_OPTIONS);
