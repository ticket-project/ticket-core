...
import com.ticket.booking.order.endpoint.CreateOrderRequest;
...
public interface OrderControllerDocs {
                            ...
                            @Header(
                                    ...
                                    schema =
                                            @Schema(
                                                    ...
                                                    example =
                                                            "/a"
                                                                    + "pi/v1/orders/ORD-3f24c6bc355148f6bf941f0b2f2a6c2b")),
                            @Header(
                                    name = "X-Order-Key",
                                    ...
                                    schema =
                                            @Schema(
                                                    ...
                                                    example =
                                                            "ORD-"
                                                                    + "3f24c6bc355148f6bf941f0b2f2a6c2b"))
                        }),
                @io.swagger.v3.oas.annotations.responses.ApiResponse(
                        responseCode = "409",
    ...
    @ApiResponses(
            value = {
                ...
                @io.swagger.v3.oas.annotations.responses.ApiResponse(
                        responseCode = "403",
                        description = "본인 주문이 아님")
            })
    ApiResponse<GetOrderDetailUseCase.Output> getOrder(
            @Parameter(
                            description = "주문 키",
                            example = "ORD-3f24c6bc355148f6bf941f0b2f2a6c2b",
                            required = true)
                    @NotBlank
                    String orderKey,
            @Parameter(hidden = true) AuthenticatedMember member);
