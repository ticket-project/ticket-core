...
public class CreateOrderPreparer {
     ...
     * booking local read (pending 주문 중복, 좌석 판매 상태)만 {@link PendingOrderLocalValidator}의 짧은 읽기
    ...
    public ValidatedOrderContext prepare(
        ...
        return new ValidatedOrderContext(policy, performanceSeats, saleSnapshot);
    }
