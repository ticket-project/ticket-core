package com.ticket.booking.domain.performanceseat.model;
 ...
 *
 * <p>{@code performanceId}/{@code seatId}/{@code performanceGradeId}는 모두 catalog aggregate를
 * 가리키는 cross-module scalar ID다. JPA 연관관계로 catalog entity를 참조하지 않는다.
 */
@Getter
@Entity
@Table(
