package com.ticket.booking.domain.ticket;
 ...
 *
 * <p>조회 실패는 {@link Optional}로 돌려주고, 그것을 어떤 오류로 볼지는 호출하는 유스케이스가 고른다. 예외를 던지는 {@code getXxx}/{@code
 * requireXxx} 편의 메서드는 두지 않는다.
 */
