package com.ticket.booking.domain.seat;

/**
 * 회차 좌석 한 건의 식별자와 판매 상태다. 담고 있는 값이 둘 다 공연 좌석의 것이라 seat가 소유한다 — 옛 {@code
 * selection.domain.SeatSelectionAvailabilitySnapshot}은 좌석 조회 계약이 selection을 참조하게 만들었다.
 *
