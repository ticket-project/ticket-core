 ...
 *
 * <p>어떤 business module도 참조하지 않는 domain-free 전역 기술 설정이 여기 있다 — {@code SwaggerConfig}, {@code P6SpyConfig},
 * {@code QuerydslConfig}, {@code RedissonConfig}, {@code EventPublicationMaintenance}, {@code SchedulingConfig},
 * {@code SystemClockConfig}. 각 module 자신의 확장점(예: {@code WebMvcConfigurer})은 그 module이 직접 등록한다 — 이 module은 그것들을 대신 등록하지
 * 않는다.
 *
 ...
 *
 * <p>{@link com.ticket.shared.config.CorsProperties}는 여기 없다 — security의 {@code ApiSecurityConfig}와 booking의
 * {@code WebSocketConfig}가 함께 쓰는 값이라 {@code shared}에 둔다.
 */
@NullMarked
