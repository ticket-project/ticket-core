 ...
 *
 * <p>각 module이 자기 코드를 {@code <Module>ErrorCode} enum으로 소유하고 이 interface를 구현한다. 코드 값(E4001 등)은 <b>외부 계약</b>이라 module이
 * 달라져도 재번호하지 않는다. 코드 대역이 module 경계와 어긋나 보이는 곳이 있는 이유가 이것이다.
 *
