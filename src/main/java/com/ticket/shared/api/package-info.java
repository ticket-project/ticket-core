 ...
 *
 * <p>공개면: {@link com.ticket.shared.api.CursorPage}(커서 페이징 조회 결과), {@link
 * com.ticket.shared.api.AuditorPrincipal}(인증 주체의 기술 중립 감사 식별자 계약), {@link
 * com.ticket.shared.api.InputChecks}(공통 입력 검증과 그 오류 문구).
 *
 ...
 * 오류 계약은 {@code shared.exception}, entity가 상속하는 JPA 기반 타입은 {@code shared.jpa}, 설정 값 홀더는 {@code
 * shared.config}다. 다섯을 하나로 합치지 않는다.
 *
