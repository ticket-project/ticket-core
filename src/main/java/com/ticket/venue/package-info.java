 ...
 *
 * <p>공개 계약은 {@code venue.api}({@code @NamedInterface("api")})에 있고 module root에는 {@code
 * package-info.java}만 둔다. {@link com.ticket.venue.api.Region}(공연장 소재 지역)은 그 package의 유일한 예외 타입이다 —
