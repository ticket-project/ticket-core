...
/**
 * venue 조회다. 상속받은 {@code findById}·{@code findAllById}가 엔티티를 그대로 주므로 별도 조회를 두지 않는다 — 공개 계약 타입으로의 변환은
 * {@link VenueRepositoryAdapter}가 한다({@code docs/readability-guidelines.md} §10-1).
 *
