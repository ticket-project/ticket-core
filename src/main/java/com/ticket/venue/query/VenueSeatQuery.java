 ...
 *
 * <p>물리 좌석 조회는 venue 자기 DB 한 번으로 끝나므로 공개 계약을 이 조회가 직접 구현한다 — 사이에 위임만 하는 service를 두면 계약과 SQL 사이에 읽을
 * 것 없는 경유 지점이 하나 늘 뿐이다. 다른 module은 계속 {@code venue.api}의 interface만 본다.
 */
@Repository
