 ...
 * 오류는 그 업무를 소유한 module의 {@code internal.exception}에 둔다.
 *
 * <p>이 module은 {@code shared}(응답 봉투)만 참조한다. 반대로 {@code shared}가 이 module을
 * 참조하면 순환이 되어 {@code com.ticket.ModularityTests}가 실패한다 —
 * {@code com.ticket.shared.ApiResponse}가 오류 타입을 모르는 이유다.
 */
