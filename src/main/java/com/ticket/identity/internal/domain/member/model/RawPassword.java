package com.ticket.identity.internal.domain.member.model;
...
//        if (rawValue == null) {
//            throw new InvalidRequestException("password는 null일 수 없습니다.");
//        }
//        final String trimmedValue = rawValue.trim();
//        if (trimmedValue.isEmpty()) {
//            throw new InvalidRequestException("password는 빈 값일 수 없습니다.");
//        }
...
//            throw new InvalidRequestException("password는 영문자를 포함해야 합니다.");
//        }
//        if (!HAS_DIGIT.matcher(trimmedValue).find()) {
//            throw new InvalidRequestException("password는 숫자를 포함해야 합니다.");
//        }
//        if (!HAS_SPECIAL.matcher(trimmedValue).find()) {
//            throw new InvalidRequestException("password는 특수문자(!@#$%^&* 등)를 포함해야 합니다.");
//        }
//        return trimmedValue;
//    }
