package com.ticket.member.internal.web;

import com.ticket.member.internal.web.request.ExchangeOAuth2TokenRequest;
import com.ticket.member.internal.web.request.LoginRequest;
import com.ticket.member.internal.web.request.RegisterMemberRequest;
import com.ticket.member.internal.web.docs.AuthControllerDocs;
import com.ticket.member.AuthenticatedMember;
import com.ticket.member.internal.application.auth.command.ExchangeOAuth2TokenUseCase;
import com.ticket.member.internal.application.auth.command.LoginUseCase;
import com.ticket.member.internal.application.auth.command.LogoutUseCase;
import com.ticket.member.internal.application.auth.command.RefreshAuthTokenUseCase;
import com.ticket.member.internal.application.auth.command.RegisterMemberUseCase;
import com.ticket.member.internal.application.auth.query.GetSocialLoginUrlsUseCase;
