...
/**
 * member가 자기 argument resolver를 직접 등록한다.
 *
 * <p>{@link AuthenticatedMemberArgumentResolver}는 다른 module의 controller가
 * {@code com.ticket.member.AuthenticatedMember} 파라미터를 받게 해 주는 member 소유 구현이다.
 ...
 */
@Configuration
class MemberWebMvcConfig implements WebMvcConfigurer {
