 ...
 * 요청한 회원이 없거나 탈퇴했다.
 *
 * <p>{@code MemberException}이 아니라 {@link NotFoundException}을 상속한다 — 오류 코드 {@code E404}와 HTTP 404 매핑을 그대로 쓴다.
 * {@code MemberException}을 상속하면 {@code MemberExceptionHandler}의 상태와 E-code로 응답이 바뀐다.
 *
