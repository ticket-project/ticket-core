...
public final class AuthorizationException extends MemberException {
    ...
    /** @param detail 어떤 권한이 없는지 좁히는 <b>공개</b> 상세 문구다. 그대로 {@code error.data}로 나가고 고정 {@code MESSAGE}를 덮지 않는다. */
