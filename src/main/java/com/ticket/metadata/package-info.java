 ...
 *
 * <p>자체 도메인이 없다 — catalog/booking/member가 공개한 {@link com.ticket.catalog.CatalogMetadata},
 * {@link com.ticket.booking.BookingMetadata}, {@link com.ticket.member.MemberMetadata}만 주입받아
 ...
 */
@ApplicationModule(displayName = "Metadata", allowedDependencies = {"catalog", "booking", "member"})
