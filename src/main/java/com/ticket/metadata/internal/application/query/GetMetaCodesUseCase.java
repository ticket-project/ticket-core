...
/**
 * 프론트가 한 번에 조회하는 공통 코드/Enum을 {@link CatalogMetadata}, {@link BookingCatalog},
...
public class GetMetaCodesUseCase {
    ...
    public Output execute() {
        ...
        final EnumCodes enums = new EnumCodes(
                ...
                toEnumCodeItems(bookingCatalog.performanceSeatStates(), BookingCatalog.CodeLabel::code, BookingCatalog.CodeLabel::label),
                toEnumCodeItems(bookingCatalog.holdStates(), BookingCatalog.CodeLabel::code, BookingCatalog.CodeLabel::label),
                toEnumCodeItems(bookingCatalog.orderStates(), BookingCatalog.CodeLabel::code, BookingCatalog.CodeLabel::label),
