...
| event publication registry 운영(purge·재제출) | `com.ticket.configuration`(전역 설정, 특정 모듈 소유 아님) |
...
| 전역 기술 설정(CORS, Swagger, WebSocket 기본 설정) | `com.ticket.configuration` 또는 아직 legacy(`com.ticket.core.config`) |
